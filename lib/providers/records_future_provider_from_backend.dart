...
@riverpod
Future<List<TransactionRecord>> fetchConfiguration(Ref ref) async {
  ...
  loadedRecords = jsonList.map((json) => TransactionRecord.fromJson(json)).toList();
  print('These are loaded records $loadedRecords');
